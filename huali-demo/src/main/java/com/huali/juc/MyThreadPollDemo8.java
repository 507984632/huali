...
public class MyThreadPollDemo8 {
    public static void main(String[] args) throws Exception {
        init();
    }

    /**
     * 最多能同时执行 maximumPoolSize + LinkedBlockingQueue.size() 的线程任务
     */
    ...
    /**
     * 最简单的 API  底层都是通过  ThreadPoolExecutor 来创建线程池的
     */
    void test() {
        //固定线程的线程池
...
//        ExecutorService executorService = Executors.newSingleThreadExecutor();
        // 可扩容的线程池 当线程任务较少的时候只有一些线程，如果多的话，可以扩容出来几个线程
